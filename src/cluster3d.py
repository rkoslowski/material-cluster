...
df2 = pd.read_csv('out/threeProps/uniqueValues.csv', sep=';')

#extract Data
dfData =df2.iloc[:,0:4].rename({'Name':'Sample','Density (g/cc)':'Density','E-Modul (GPa)': 'ModulusOfElasticity','Poissons Ratio':'PoissonsRatio'}, axis=1)
dfData.to_csv('out/dataAndLabel/data3d.csv', ';', columns=['Sample','Density', 'ModulusOfElasticity'], index_label=False , index=False)
...
datafile 	= "out/dataAndLabel/data3d.csv"
...
#pcadf["den"] = NormalizeData(pcadf["den"]) ##, sharez=True,projection='3d'
